...
const new_numbers = [1,2,3,4,5];
const doubledNumbers = new_numbers.map((num) => num * 2);
console.log("Doubled numbers:",doubledNumbers);
const evenNumbers = new_numbers.filter((num) => num % 2 === 0);
console.log("Even numbers*",evenNumbers);
MyClass.prototype
Object.getOwnPropertyNames
MyClass.prototype.print_size
my_obj = new MyClass(160,53)
my_obj.__proto__
const temp = {}
temp instanceof MyClass
...
// MyClass のプロトタイプを空のオブジェクトに代入
MyClass.prototype = emptyObject;

// 空のオブジェクトがクラスのインスタンスとして使用できるか確認
